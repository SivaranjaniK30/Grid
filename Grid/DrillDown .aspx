...
<body>
    <form id="form1" runat="server">
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:demoConn10 %>" SelectCommand="SELECT * FROM [tblContinents]"></asp:SqlDataSource>
        <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:demoConn10 %>" SelectCommand="SELECT * FROM [tblCountries] WHERE ([ContinentId] = @ContinentId)">
            <SelectParameters>
                <asp:ControlParameter ControlID="GridView1" Name="ContinentId" PropertyName="SelectedValue" Type="Int32" />
            </SelectParameters>
        </asp:SqlDataSource>
        <asp:SqlDataSource ID="SqlDataSource3" runat="server" ConnectionString="<%$ ConnectionStrings:demoConn10 %>" SelectCommand="SELECT * FROM [tblCities] WHERE ([CountryId] = @CountryId)">
            <SelectParameters>
