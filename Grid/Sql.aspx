...
<body>
    <form id="form1" runat="server">
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:TaskConn2 %>" SelectCommand="SELECT [id], [Name], [Price] FROM [Product]"></asp:SqlDataSource>
